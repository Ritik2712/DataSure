    ...
    <main className="flex flex-col items-center bg-white text-gray-900 px-6 py-16">
      <div className="max-w-4xl w-full space-y-8">
        ...
        <section className="space-y-4 text-lg text-gray-700 leading-relaxed">
          <p>
            A client preparing to spin off part of their business needed reliable, entity-level balance sheets. Their
            finance team was working with raw Excel extracts that were difficult to consolidate and prone to errors. They
            wanted a repeatable way to produce dynamic balance sheet reports for each legal entity, without days of
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>Flattened and cleaned raw Excel data into a consistent tabular format.</li>
            <li>Built dimension and fact tables (Accounts, Time, Entities) in a SQL database using a star schema.</li>
            <li>Automated data modelling so account hierarchies and entity structures were reusable across reports.</li>
            <li>Connected SQL to Excel to deliver dynamic, refreshable pivot-based balance sheets.</li>
          </ul>
